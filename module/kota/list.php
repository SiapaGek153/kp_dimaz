			...
			while($rowKota=mysqli_fetch_assoc($queryKota)){
				echo "<tr>
						...
						<td class='tengah'>
							...
							<a onclick='confirm(`Apakah ingin menghapus item?`) ? window.location.href = `".BASE_URL."module/kota/action.php?button=Delete&kota_id=$rowKota[kota_id]` : location.reload();' class='tombol-action'>Delete</a>
						</td>
					 </tr>";
