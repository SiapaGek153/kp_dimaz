...
<div id="frame-tambah" class="barang">
	<div id="left">
	...
	<div id="right">
		<a href="<?php echo BASE_URL."index.php?page=my_profile&module=barang&action=form"; ?>" class="tombol-action tombol">+ Tambah Barang</a>
	</div>
